                ...
                <div class="card-body">
                  <form>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Major/Minor projects</label>
                          
                          <select class="form-control">
                              
                              <option>More than 20 lacs for Science & more than 10 lacs for arts</option>
                              <option>Below 20 lacs for Science & below 10 lacs for Arts</option>
                              <option>Minor projects</option>
                              <option>Don Bosco Research grant</option>
                              <option>Sacred Heart fellowship</option>
                              <option>TNSCST project (2017-18)</option>
                          </select>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Consultancy services offered</label>
                          <select class="form-control">
                              <option>--- Select ---</option>
                              <option>More than Rs.50,000/-</option>
                              <option>Between Rs. 25,000 and Rs.50,000/-</option>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Funding for Conferences/Seminars</label>
                          <select class="form-control">
                              <option>--- Select ---</option>
                              <option>Government Funding agencies</option>
                              <option>Private agencies (Only if amount received is more than Rs. 25,000/-)</option>
                          </select>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Patents</label>
                          
                          
                          <select class="form-control">
                              <option>--- Select ---</option>
                              <option>Patent Registered (International)</option>
                              <option>Patent (National)</option>
                          </select>
