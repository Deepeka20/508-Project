...
<div class="container">
    <div class="row">
        ...
        <div class="container" style="margin-top: 80px;">
            <form action="studentdepartment.jsp" method="POST">
            <div class="row">
                <div class="col-md-6">
...
String sql ="SELECT *, (SUM(publications_in_journals)+SUM(number_of_citations)+SUM(total_impact_factor)+SUM(paper_presentations)+SUM(patents)+SUM(visit_to_abroad)+SUM(awards_fellowships)+SUM(best_presentations)) as total FROM studentdocument";
if(!dept.equalsIgnoreCase("all")) {
    sql += " WHERE department = '"+dept+"' GROUP BY regno";
}
