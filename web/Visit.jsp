                ...
                <div class="card-body">
                  <form>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Visit to Abroad</label>
                          
                          <div class="checkbox">
                            <label>
                                <input type="checkbox" value="" >
                                As resource person/Visiting Scientist
                            </label>
                        </div>
                          <div class="checkbox">
                            <label>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Awards/Fellowships</label>
                          <div class="checkbox">
                            <label>
                                <input type="checkbox" value="" >
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Best Presentations Award International Conferences/Seminars</label>
                          <input class="form-control" type="text"/>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Best Presentations Award National Conferences/Seminars</label>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Invited talks International (Abroad)</label>
                          <input class="form-control" type="text"/>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">International (Within Country)</label>
